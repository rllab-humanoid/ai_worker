...
def generate_launch_description():
    declared_arguments = [
        ...
        DeclareLaunchArgument('right_hand_port_name', default_value='/dev/right_hand',
                              description='Port name for right robotis hand connection.'),
        ...
        DeclareLaunchArgument('model', default_value='ffw_sh5_rev1_follower_right_hand_left_gripper',
    ...
    right_hand_port_name = LaunchConfiguration('right_hand_port_name')
    ...
    robot_description_content = Command([
        ...
        'port_name:=', port_name,
        ' ',
        'right_hand_port_name:=', right_hand_port_name,
        ' ',
        'model:=', model,
        ' ',
